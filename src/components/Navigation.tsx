...
export default function Navigation({ theme = "dark" }: NavigationProps) {
  ...
  const [removeFromCart, { loading: removingItem }] = useMutation(
    REMOVE_CART_ITEM,
    {
      onCompleted: () => {
        refetchCart();
      ...
      >
        <div className="max-w-[1800px] mx-auto grid grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-end gap-5">
            {/* Narrative Link */}
            <div className="hidden md:flex items-center pr-5 border-r border-black/5">
              <a
                    ...
                    <div className="space-y-6">
                      {cartData?.cart?.contents?.nodes
                        ?.filter((item: any) => {
                          ...
                          return (
                            !productSlug.includes("fee") &&
                            !productSlug.includes("customization")
                          );
                        })
                        .map((item: any) => {
                          const productName =
                          ...
                          // Parse Customization
                          const customization = item.extraData?.find(
                            (m: any) =>
                              m.key === "Customization" ||
                              m.key === "customization",
                          );
                          ...
                          return (
                            <div
                              key={item.key}
                              className={`group relative flex gap-5 ${removingKey === item.key ? "opacity-50" : ""}`}
                            >
                                ...
                                <div>
                                  ...
                                  <div
                                    ...
                                    dangerouslySetInnerHTML={{
                                      __html: cleanPrice(item.subtotal || ""),
                                    }}
                                  />
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex justify-between text-xs text-neutral-500 uppercase tracking-widest">
                      ...
                      <span
                        ...
                        dangerouslySetInnerHTML={{
                          __html: cleanPrice(cartData?.cart?.subtotal || ""),
                        }}
                      />
                    </div>
                    ...
                    {/* Fees */}
                    {cartData?.cart?.fees &&
                      cartData.cart.fees.map((fee: any, idx: number) => (
                        <div
                          key={idx}
                          className="flex justify-between text-xs text-neutral-500 uppercase tracking-widest"
                        >
                          <span>{fee.name}</span>
                          <span
                            className="text-black font-bold"
                            dangerouslySetInnerHTML={{
                              __html: cleanPrice(fee.total || ""),
                            }}
                          />
                        </div>
                      ))}
          ...
          >
            ...
            <div className="max-w-4xl mx-auto w-full">
              ...
              <div className="mt-12 grid grid-cols-2 md:grid-cols-3 gap-8">
                ...
                {searchData?.products?.nodes.length === 0 &&
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="space-y-6">
                <h4 className="text-[10px] font-bold text-neutral-700 uppercase tracking-[0.6em] mb-4">
                  Universe
                </h4>
                <a
                  href="https://anecdote.drotes.com"
                ...
                >
                  ...
                  <span className="text-xl text-white font-light uppercase tracking-wider">
                    Anecdote
                  </span>
                </a>
                <a
                ...
                <a
                  href="https://founder.drotes.com"
                  target="_blank"
                  className="flex items-center gap-4 group opacity-60"
                >
                  <span className="text-xl text-white font-light uppercase tracking-wider pl-6">
                    Founder's Note
                  </span>
                </a>
              </div>
